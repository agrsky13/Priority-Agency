  ...
  return (
    <section id="contact" className="py-16 sm:py-20 md:py-28 bg-gradient-to-b from-neutral-900 to-neutral-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/3 w-80 h-80 bg-gradient-to-r from-amber-900/8 to-neutral-800/5 rounded-full mix-blend-screen filter blur-[100px]"></div>
        <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-gradient-to-r from-neutral-700/8 to-neutral-600/5 rounded-full mix-blend-screen filter blur-[100px]"></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12 sm:mb-16 md:mb-20">
          ...
          <p className="text-neutral-400 text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Need facts about someone or something? We gather evidence discreetly 
            while you make the decisions. First consultation is free.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 md:gap-8 mb-12 sm:mb-16">
            {[
              ...
              >
                {/* Hover Glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-white/0 to-white/0 group-hover:from-white/5 group-hover:to-white/0 transition-all duration-500 rounded-xl"></div>
                ...
                {/* Content */}
                <h4 className="relative font-bold text-neutral-100 mb-2 text-lg sm:text-xl">
                  {contact.title}
                </h4>
                <p className="relative text-neutral-300 font-medium mb-2 text-base sm:text-lg break-words">
                  {contact.value}
                </p>
                <p className="relative text-neutral-500 text-sm">
                  {contact.description}
                </p>
          ...
          <div className="bg-neutral-900/60 backdrop-blur-sm border border-neutral-800/50 rounded-2xl p-8 sm:p-10 md:p-12 text-center relative overflow-hidden">
            {/* Accent Line */}
            <div className="absolute top-0 left-1/4 right-1/4 h-px bg-gradient-to-r from-transparent via-amber-500/50 to-transparent"></div>
            
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-neutral-100 mb-4">
              Ready to Uncover the Truth?
            </h3>
            <p className="text-neutral-400 text-base sm:text-lg mb-8 max-w-xl mx-auto leading-relaxed">
              Take the first step toward clarity. Contact us for a confidential, 
            ...
            <div className="mt-8 pt-8 border-t border-neutral-800/50">
              <div className="flex items-center justify-center gap-2 text-neutral-500 text-sm">
                ...
                <span>Your inquiry is 100% confidential</span>
              </div>
            </div>
          </div>
        </div>
