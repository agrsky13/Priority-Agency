    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10 pt-32 pb-24">
        <div className="max-w-4xl mx-auto">
          <button onClick={onBack} className="text-gray-400 hover:text-white transition-colors duration-300 mb-8 flex items-center space-x-2">
            <span>←</span>
            <span>Вернуться к блогу</span>
          </button>
          
          <article className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            <div className="mb-6">
              <span className="inline-block bg-white/10 backdrop-blur-xl border border-white/20 text-white px-3 py-1 rounded-full text-xs font-medium mb-4">
                {post.category}
              </span>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Первые действия при исчезновении</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Обращение к профессионалам</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Современные методы поиска</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Работа с информацией</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Основные угрозы корпоративной безопасности</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Внутренние угрозы</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Методы защиты информации</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Роль частных детективов</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Анализ социальных сетей</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Банковские операции и финансовая активность</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">GPS и геолокация</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Мобильные устройства и приложения</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Вербальные признаки лжи</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Невербальные сигналы</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Физиологические реакции</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Методы выявления лжи</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Что разрешено частному детективу</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Правовые ограничения</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Лицензирование деятельности</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Ответственность детектива</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Видеонаблюдение и скрытые камеры</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">GPS-трекинг и геолокация</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Электронная разведка</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">Дроны и аэрофотосъемка</h2>
              <p className="text-gray-300 leading-relaxed mb-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-gradient-to-r from-white/6 to-gray-200/6 rounded-full mix-blend-screen filter blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-gradient-to-r from-gray-100/8 to-white/8 rounded-full mix-blend-screen filter blur-3xl animate-pulse delay-1000"></div>
      </div>

      <div className="container mx-auto px-4 relative z-10 pt-32 pb-24">
        {/* Page Header */}
        <div className="text-center mb-16">
          <div className="inline-block bg-white/10 backdrop-blur-xl border border-white/20 text-white px-6 py-3 rounded-full text-sm font-medium mb-6">
            Блог
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <article 
              key={post.id}
              className="group bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden hover:bg-white/10 hover:shadow-2xl hover:shadow-white/5 transition-all duration-500 hover:scale-105 cursor-pointer"
              onClick={() => handlePostClick(post.id)}
            >
              {/* Post Header */}
              <div className="p-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="inline-block bg-white/10 backdrop-blur-xl border border-white/20 text-white px-3 py-1 rounded-full text-xs font-medium">
                    {post.category}
                  </span>
                </div>

                <h3 className="text-xl font-bold text-white mb-4 group-hover:text-gray-200 transition-colors duration-300 leading-tight">
                  {post.title}
                </h3>
                ...
                {/* Read More Button */}
                <div className="w-full bg-white/10 backdrop-blur-xl border border-white/20 text-white py-3 rounded-xl hover:bg-white/20 transition-all duration-300 font-medium text-center">
                  Читать полностью
                </div>
              </div>
            </article>
        ...
        <div className="text-center mt-12">
          <button 
            ...
            className="text-gray-400 hover:text-white transition-colors duration-300 flex items-center justify-center space-x-2 mx-auto"
          >
            <span>←</span>
