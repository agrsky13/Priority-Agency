...
export function CookieConsent() {
  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-neutral-900/95 backdrop-blur-xl border-t border-neutral-400/20 p-4 md:p-6 pb-[max(1rem,env(safe-area-inset-bottom))]">
